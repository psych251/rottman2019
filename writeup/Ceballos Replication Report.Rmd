...
## For the difference of means analysis, I will use the functions means. I'll also have to use group_by and summarize, together, to get the mean of the appropriate rows.
